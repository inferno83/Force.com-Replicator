...
class Replicator {
  ...
  private function loadOptions() {
      ...
      if (isset($dbOptions['db_user']) || isset($dbOptions['db_pass']) || isset($dbOptions['db_host']) || isset($dbOptions['db_database'])) {
          $optionsNotUsed = array_diff(['db_user', 'db_pass', 'db_host', 'db_database'], array_keys($dbOptions));
